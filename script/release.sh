...
export LITHEPG_GITHUB_ACTIONS_READY="${LITHEPG_GITHUB_ACTIONS_READY:-}"
export LITHEPG_RELEASE_COPY_APPROVED="${LITHEPG_RELEASE_COPY_APPROVED:-}"
export LITHEPG_PUBLICATION_APPROVED="${LITHEPG_PUBLICATION_APPROVED:-}"
...
(
  ...
  brew audit --online --strict --cask "$LITHEPG_HOMEBREW_TAP/lithepg"
)
