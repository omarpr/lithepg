...
write_app_icon_fixture() {
  ...
  printf '\x69\x63\x6e\x73\x00\x00\x00\x11ic10\x00\x00\x00\x09\x00' >"$app_bundle_path/Contents/Resources/AppIcon.icns"
...
printf '\x69\x63\x6e\x73\x00\x00\x00\x11icp4\x00\x00\x00\x09\x00' >"$malformed_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Resources/AppIcon.icns"
