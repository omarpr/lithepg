...
artifact_app_icon_bad_low_resolution_sibling_output="$(mktemp)"
...
artifact_app_icon_reserved_bit_output="$(mktemp)"
artifact_app_icon_unknown_critical_output="$(mktemp)"
artifact_app_icon_unknown_ancillary_output="$(mktemp)"
artifact_app_icon_invalid_srgb_output="$(mktemp)"
artifact_app_icon_invalid_gama_output="$(mktemp)"
artifact_app_icon_invalid_chrm_output="$(mktemp)"
artifact_app_icon_invalid_iccp_output="$(mktemp)"
...
artifact_app_icon_text_metadata_output="$(mktemp)"
artifact_app_icon_timestamp_metadata_output="$(mktemp)"
artifact_app_icon_exif_metadata_output="$(mktemp)"
artifact_app_icon_physical_pixel_metadata_output="$(mktemp)"
artifact_app_icon_significant_bits_metadata_output="$(mktemp)"
artifact_app_icon_background_metadata_output="$(mktemp)"
artifact_app_icon_histogram_metadata_output="$(mktemp)"
...
special_mode_bundle_zip_dir="$(mktemp -d)"
special_mode_bundle_zip="$special_mode_bundle_zip_dir/LithePG.app.zip"
special_mode_bundle_release_copy="$(mktemp)"
special_mode_bundle_homebrew_cask="$(mktemp)"
writable_mode_bundle_zip_dir="$(mktemp -d)"
...
bad_low_resolution_sibling_app_icon_zip_dir="$(mktemp -d)"
bad_low_resolution_sibling_app_icon_zip="$bad_low_resolution_sibling_app_icon_zip_dir/LithePG.app.zip"
bad_low_resolution_sibling_app_icon_release_copy="$(mktemp)"
bad_low_resolution_sibling_app_icon_homebrew_cask="$(mktemp)"
duplicate_element_app_icon_zip_dir="$(mktemp -d)"
...
invalid_chunk_type_app_icon_homebrew_cask="$(mktemp)"
reserved_bit_app_icon_zip_dir="$(mktemp -d)"
reserved_bit_app_icon_zip="$reserved_bit_app_icon_zip_dir/LithePG.app.zip"
reserved_bit_app_icon_release_copy="$(mktemp)"
reserved_bit_app_icon_homebrew_cask="$(mktemp)"
unknown_critical_app_icon_zip_dir="$(mktemp -d)"
unknown_critical_app_icon_zip="$unknown_critical_app_icon_zip_dir/LithePG.app.zip"
unknown_critical_app_icon_release_copy="$(mktemp)"
unknown_critical_app_icon_homebrew_cask="$(mktemp)"
unknown_ancillary_app_icon_zip_dir="$(mktemp -d)"
unknown_ancillary_app_icon_zip="$unknown_ancillary_app_icon_zip_dir/LithePG.app.zip"
unknown_ancillary_app_icon_release_copy="$(mktemp)"
unknown_ancillary_app_icon_homebrew_cask="$(mktemp)"
invalid_srgb_app_icon_zip_dir="$(mktemp -d)"
invalid_srgb_app_icon_zip="$invalid_srgb_app_icon_zip_dir/LithePG.app.zip"
invalid_srgb_app_icon_release_copy="$(mktemp)"
invalid_srgb_app_icon_homebrew_cask="$(mktemp)"
invalid_gama_app_icon_zip_dir="$(mktemp -d)"
invalid_gama_app_icon_zip="$invalid_gama_app_icon_zip_dir/LithePG.app.zip"
invalid_gama_app_icon_release_copy="$(mktemp)"
invalid_gama_app_icon_homebrew_cask="$(mktemp)"
invalid_chrm_app_icon_zip_dir="$(mktemp -d)"
invalid_chrm_app_icon_zip="$invalid_chrm_app_icon_zip_dir/LithePG.app.zip"
invalid_chrm_app_icon_release_copy="$(mktemp)"
invalid_chrm_app_icon_homebrew_cask="$(mktemp)"
invalid_iccp_app_icon_zip_dir="$(mktemp -d)"
invalid_iccp_app_icon_zip="$invalid_iccp_app_icon_zip_dir/LithePG.app.zip"
invalid_iccp_app_icon_release_copy="$(mktemp)"
invalid_iccp_app_icon_homebrew_cask="$(mktemp)"
oversized_dimensions_app_icon_zip_dir="$(mktemp -d)"
...
trns_alpha_app_icon_zip_dir="$(mktemp -d)"
...
text_metadata_app_icon_zip_dir="$(mktemp -d)"
text_metadata_app_icon_zip="$text_metadata_app_icon_zip_dir/LithePG.app.zip"
text_metadata_app_icon_release_copy="$(mktemp)"
text_metadata_app_icon_homebrew_cask="$(mktemp)"
timestamp_metadata_app_icon_zip_dir="$(mktemp -d)"
timestamp_metadata_app_icon_zip="$timestamp_metadata_app_icon_zip_dir/LithePG.app.zip"
timestamp_metadata_app_icon_release_copy="$(mktemp)"
timestamp_metadata_app_icon_homebrew_cask="$(mktemp)"
exif_metadata_app_icon_zip_dir="$(mktemp -d)"
exif_metadata_app_icon_zip="$exif_metadata_app_icon_zip_dir/LithePG.app.zip"
exif_metadata_app_icon_release_copy="$(mktemp)"
exif_metadata_app_icon_homebrew_cask="$(mktemp)"
physical_pixel_metadata_app_icon_zip_dir="$(mktemp -d)"
physical_pixel_metadata_app_icon_zip="$physical_pixel_metadata_app_icon_zip_dir/LithePG.app.zip"
physical_pixel_metadata_app_icon_release_copy="$(mktemp)"
physical_pixel_metadata_app_icon_homebrew_cask="$(mktemp)"
significant_bits_metadata_app_icon_zip_dir="$(mktemp -d)"
significant_bits_metadata_app_icon_zip="$significant_bits_metadata_app_icon_zip_dir/LithePG.app.zip"
significant_bits_metadata_app_icon_release_copy="$(mktemp)"
significant_bits_metadata_app_icon_homebrew_cask="$(mktemp)"
background_metadata_app_icon_zip_dir="$(mktemp -d)"
background_metadata_app_icon_zip="$background_metadata_app_icon_zip_dir/LithePG.app.zip"
background_metadata_app_icon_release_copy="$(mktemp)"
background_metadata_app_icon_homebrew_cask="$(mktemp)"
histogram_metadata_app_icon_zip_dir="$(mktemp -d)"
histogram_metadata_app_icon_zip="$histogram_metadata_app_icon_zip_dir/LithePG.app.zip"
histogram_metadata_app_icon_release_copy="$(mktemp)"
histogram_metadata_app_icon_homebrew_cask="$(mktemp)"
...
duplicate_essential_entries_homebrew_cask="$(mktemp)"
noncanonical_zip_path_dir="$(mktemp -d)"
...
unicode_zip_path_collision_dir="$(mktemp -d)"
...
unsafe_code_resources_mode_zip_dir="$(mktemp -d)"
...
invalid_metadata_zip_dir="$(mktemp -d)"
...
malformed_metadata_homebrew_cask="$(mktemp)"
...
cleanup() {
  rm -f \
    ...
    "$artifact_app_icon_bad_low_resolution_sibling_output" \
    ...
    "$artifact_app_icon_reserved_bit_output" \
    "$artifact_app_icon_unknown_critical_output" \
    "$artifact_app_icon_unknown_ancillary_output" \
    "$artifact_app_icon_invalid_srgb_output" \
    "$artifact_app_icon_invalid_gama_output" \
    "$artifact_app_icon_invalid_chrm_output" \
    "$artifact_app_icon_invalid_iccp_output" \
    "$artifact_app_icon_oversized_dimensions_output" \
    "$artifact_app_icon_trns_alpha_output" \
    "$artifact_app_icon_trailing_zlib_output" \
    "$artifact_app_icon_text_metadata_output" \
    "$artifact_app_icon_timestamp_metadata_output" \
    "$artifact_app_icon_exif_metadata_output" \
    "$artifact_app_icon_physical_pixel_metadata_output" \
    "$artifact_app_icon_significant_bits_metadata_output" \
    "$artifact_app_icon_background_metadata_output" \
    "$artifact_app_icon_histogram_metadata_output" \
    ...
    "$special_mode_bundle_zip" \
    "$special_mode_bundle_release_copy" \
    "$special_mode_bundle_homebrew_cask" \
    ...
    "$bad_low_resolution_sibling_app_icon_zip" \
    "$bad_low_resolution_sibling_app_icon_release_copy" \
    "$bad_low_resolution_sibling_app_icon_homebrew_cask" \
    ...
    "$reserved_bit_app_icon_zip" \
    "$reserved_bit_app_icon_release_copy" \
    "$reserved_bit_app_icon_homebrew_cask" \
    "$unknown_critical_app_icon_zip" \
    "$unknown_critical_app_icon_release_copy" \
    "$unknown_critical_app_icon_homebrew_cask" \
    "$unknown_ancillary_app_icon_zip" \
    "$unknown_ancillary_app_icon_release_copy" \
    "$unknown_ancillary_app_icon_homebrew_cask" \
    "$invalid_srgb_app_icon_zip" \
    "$invalid_srgb_app_icon_release_copy" \
    "$invalid_srgb_app_icon_homebrew_cask" \
    "$invalid_gama_app_icon_zip" \
    "$invalid_gama_app_icon_release_copy" \
    "$invalid_gama_app_icon_homebrew_cask" \
    "$invalid_chrm_app_icon_zip" \
    "$invalid_chrm_app_icon_release_copy" \
    "$invalid_chrm_app_icon_homebrew_cask" \
    "$invalid_iccp_app_icon_zip" \
    "$invalid_iccp_app_icon_release_copy" \
    "$invalid_iccp_app_icon_homebrew_cask" \
    ...
    "$text_metadata_app_icon_zip" \
    "$text_metadata_app_icon_release_copy" \
    "$text_metadata_app_icon_homebrew_cask" \
    "$timestamp_metadata_app_icon_zip" \
    "$timestamp_metadata_app_icon_release_copy" \
    "$timestamp_metadata_app_icon_homebrew_cask" \
    "$exif_metadata_app_icon_zip" \
    "$exif_metadata_app_icon_release_copy" \
    "$exif_metadata_app_icon_homebrew_cask" \
    "$physical_pixel_metadata_app_icon_zip" \
    "$physical_pixel_metadata_app_icon_release_copy" \
    "$physical_pixel_metadata_app_icon_homebrew_cask" \
    "$significant_bits_metadata_app_icon_zip" \
    "$significant_bits_metadata_app_icon_release_copy" \
    "$significant_bits_metadata_app_icon_homebrew_cask" \
    "$background_metadata_app_icon_zip" \
    "$background_metadata_app_icon_release_copy" \
    "$background_metadata_app_icon_homebrew_cask" \
    "$histogram_metadata_app_icon_zip" \
    "$histogram_metadata_app_icon_release_copy" \
    "$histogram_metadata_app_icon_homebrew_cask" \
...
first_element = icon[8:]
duplicate_icon = b"icns" + (len(first_element) * 2 + 8).to_bytes(4, "big") + first_element + first_element
...
/usr/bin/python3 - "$release_zip_fixture" "$unsafe_code_resources_mode_zip" <<'PY'
import sys
import zipfile
...
/usr/bin/python3 - "$release_zip_fixture" "$empty_code_resources_zip" <<'PY'
import sys
import zipfile
...
with zipfile.ZipFile(source_zip, "r") as source, zipfile.ZipFile(destination_zip, "w") as destination:
    for source_entry in source.infolist():
        ...
        destination_entry.create_system = source_entry.create_system
        destination_entry.compress_type = source_entry.compress_type
        payload = b"" if source_entry.filename == code_resources_path else source.read(source_entry.filename)
...
malformed_metadata_zip_sha="$(/usr/bin/shasum -a 256 "$malformed_metadata_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$malformed_metadata_zip_sha" >"$malformed_metadata_release_copy"
...
/usr/bin/python3 - "$release_zip_fixture" "$special_mode_bundle_zip" <<'PY'
import sys
import zipfile
...
with zipfile.ZipFile(destination_zip, "w") as destination:
    for entry, payload in entries:
        if entry.filename == "LithePG.app/Contents/MacOS/LithePGApp":
            entry.create_system = 3
            entry.external_attr = (0o102755 & 0xFFFF) << 16
        destination.writestr(entry, payload)
PY
special_mode_bundle_zip_sha="$(/usr/bin/shasum -a 256 "$special_mode_bundle_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$special_mode_bundle_zip_sha" >"$special_mode_bundle_release_copy"
/usr/bin/python3 - "$release_zip_fixture" "$writable_mode_bundle_zip" <<'PY'
import sys
import zipfile
...
with zipfile.ZipFile(destination_zip, "w") as destination:
    for entry, payload in entries:
        if entry.filename == "LithePG.app/Contents/MacOS/LithePGApp":
            entry.create_system = 3
            entry.external_attr = (0o100777 & 0xFFFF) << 16
        destination.writestr(entry, payload)
PY
...
write_post_iend_app_icon_fixture "$malformed_app_icon_zip_dir/fixture-root/LithePG.app"
...
mkdir -p "$bad_low_resolution_sibling_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$bad_low_resolution_sibling_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$bad_low_resolution_sibling_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$bad_low_resolution_sibling_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_bad_low_resolution_png_sibling_app_icon_fixture "$bad_low_resolution_sibling_app_icon_zip_dir/fixture-root/LithePG.app"
bad_low_resolution_sibling_app_icon_marker="BAD_LOW_RESOLUTION_SIBLING_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$bad_low_resolution_sibling_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$bad_low_resolution_sibling_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$bad_low_resolution_sibling_app_icon_zip" LithePG.app
)
bad_low_resolution_sibling_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$bad_low_resolution_sibling_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$bad_low_resolution_sibling_app_icon_zip_sha" >"$bad_low_resolution_sibling_app_icon_release_copy"
mkdir -p "$duplicate_element_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$duplicate_element_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$duplicate_element_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$duplicate_element_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_duplicate_icns_image_element_app_icon_fixture "$duplicate_element_app_icon_zip_dir/fixture-root/LithePG.app"
duplicate_element_app_icon_marker="DUPLICATE_ICNS_ELEMENT_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$duplicate_element_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$duplicate_element_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$duplicate_element_app_icon_zip" LithePG.app
)
...
/bin/chmod 755 "$invalid_chunk_type_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_invalid_png_chunk_type_app_icon_fixture "$invalid_chunk_type_app_icon_zip_dir/fixture-root/LithePG.app"
invalid_chunk_type_app_icon_marker="INVALID_CHUNK_TYPE_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$invalid_chunk_type_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$invalid_chunk_type_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$invalid_chunk_type_app_icon_zip" LithePG.app
)
invalid_chunk_type_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$invalid_chunk_type_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$invalid_chunk_type_app_icon_zip_sha" >"$invalid_chunk_type_app_icon_release_copy"
mkdir -p "$reserved_bit_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$reserved_bit_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$reserved_bit_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$reserved_bit_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_reserved_bit_png_chunk_app_icon_fixture "$reserved_bit_app_icon_zip_dir/fixture-root/LithePG.app"
reserved_bit_app_icon_marker="RESERVED_BIT_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$reserved_bit_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$reserved_bit_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$reserved_bit_app_icon_zip" LithePG.app
)
reserved_bit_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$reserved_bit_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$reserved_bit_app_icon_zip_sha" >"$reserved_bit_app_icon_release_copy"
mkdir -p "$unknown_critical_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$unknown_critical_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$unknown_critical_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$unknown_critical_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_unknown_critical_png_chunk_app_icon_fixture "$unknown_critical_app_icon_zip_dir/fixture-root/LithePG.app"
unknown_critical_app_icon_marker="UNKNOWN_CRITICAL_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$unknown_critical_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$unknown_critical_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$unknown_critical_app_icon_zip" LithePG.app
)
unknown_critical_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$unknown_critical_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$unknown_critical_app_icon_zip_sha" >"$unknown_critical_app_icon_release_copy"
mkdir -p "$unknown_ancillary_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$unknown_ancillary_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$unknown_ancillary_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$unknown_ancillary_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_unknown_ancillary_png_chunk_app_icon_fixture "$unknown_ancillary_app_icon_zip_dir/fixture-root/LithePG.app"
unknown_ancillary_app_icon_marker="UNKNOWN_ANCILLARY_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$unknown_ancillary_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$unknown_ancillary_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$unknown_ancillary_app_icon_zip" LithePG.app
)
unknown_ancillary_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$unknown_ancillary_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$unknown_ancillary_app_icon_zip_sha" >"$unknown_ancillary_app_icon_release_copy"
mkdir -p "$invalid_srgb_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$invalid_srgb_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$invalid_srgb_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$invalid_srgb_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_invalid_srgb_png_chunk_app_icon_fixture "$invalid_srgb_app_icon_zip_dir/fixture-root/LithePG.app"
invalid_srgb_app_icon_marker="INVALID_SRGB_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$invalid_srgb_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$invalid_srgb_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$invalid_srgb_app_icon_zip" LithePG.app
)
invalid_srgb_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$invalid_srgb_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$invalid_srgb_app_icon_zip_sha" >"$invalid_srgb_app_icon_release_copy"
mkdir -p "$invalid_gama_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$invalid_gama_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$invalid_gama_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$invalid_gama_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_invalid_gama_png_chunk_app_icon_fixture "$invalid_gama_app_icon_zip_dir/fixture-root/LithePG.app"
invalid_gama_app_icon_marker="INVALID_GAMA_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$invalid_gama_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$invalid_gama_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$invalid_gama_app_icon_zip" LithePG.app
)
invalid_gama_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$invalid_gama_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$invalid_gama_app_icon_zip_sha" >"$invalid_gama_app_icon_release_copy"
mkdir -p "$invalid_chrm_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$invalid_chrm_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$invalid_chrm_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$invalid_chrm_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_invalid_chrm_png_chunk_app_icon_fixture "$invalid_chrm_app_icon_zip_dir/fixture-root/LithePG.app"
invalid_chrm_app_icon_marker="INVALID_CHRM_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$invalid_chrm_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$invalid_chrm_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$invalid_chrm_app_icon_zip" LithePG.app
)
invalid_chrm_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$invalid_chrm_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$invalid_chrm_app_icon_zip_sha" >"$invalid_chrm_app_icon_release_copy"
mkdir -p "$invalid_iccp_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$invalid_iccp_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$invalid_iccp_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$invalid_iccp_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_invalid_iccp_png_chunk_app_icon_fixture "$invalid_iccp_app_icon_zip_dir/fixture-root/LithePG.app"
invalid_iccp_app_icon_marker="INVALID_ICCP_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$invalid_iccp_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$invalid_iccp_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$invalid_iccp_app_icon_zip" LithePG.app
)
invalid_iccp_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$invalid_iccp_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$invalid_iccp_app_icon_zip_sha" >"$invalid_iccp_app_icon_release_copy"
mkdir -p "$oversized_dimensions_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$oversized_dimensions_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$oversized_dimensions_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$oversized_dimensions_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_oversized_png_dimensions_app_icon_fixture "$oversized_dimensions_app_icon_zip_dir/fixture-root/LithePG.app"
oversized_dimensions_app_icon_marker="OVERSIZED_DIMENSIONS_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$oversized_dimensions_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$oversized_dimensions_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$oversized_dimensions_app_icon_zip" LithePG.app
)
...
mkdir -p "$trns_alpha_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$trns_alpha_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$trns_alpha_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$trns_alpha_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_rgba_png_trns_app_icon_fixture "$trns_alpha_app_icon_zip_dir/fixture-root/LithePG.app"
trns_alpha_app_icon_marker="TRNS_ALPHA_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$trns_alpha_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$trns_alpha_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$trns_alpha_app_icon_zip" LithePG.app
)
...
mkdir -p "$text_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$text_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$text_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$text_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_text_metadata_app_icon_fixture "$text_metadata_app_icon_zip_dir/fixture-root/LithePG.app"
text_metadata_app_icon_marker="TEXT_METADATA_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$text_metadata_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$text_metadata_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$text_metadata_app_icon_zip" LithePG.app
)
text_metadata_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$text_metadata_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$text_metadata_app_icon_zip_sha" >"$text_metadata_app_icon_release_copy"
mkdir -p "$timestamp_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$timestamp_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$timestamp_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$timestamp_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_timestamp_metadata_app_icon_fixture "$timestamp_metadata_app_icon_zip_dir/fixture-root/LithePG.app"
timestamp_metadata_app_icon_marker="TIMESTAMP_METADATA_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$timestamp_metadata_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$timestamp_metadata_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$timestamp_metadata_app_icon_zip" LithePG.app
)
timestamp_metadata_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$timestamp_metadata_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$timestamp_metadata_app_icon_zip_sha" >"$timestamp_metadata_app_icon_release_copy"
mkdir -p "$exif_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$exif_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$exif_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$exif_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_exif_metadata_app_icon_fixture "$exif_metadata_app_icon_zip_dir/fixture-root/LithePG.app"
exif_metadata_app_icon_marker="EXIF_METADATA_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$exif_metadata_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$exif_metadata_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$exif_metadata_app_icon_zip" LithePG.app
)
exif_metadata_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$exif_metadata_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$exif_metadata_app_icon_zip_sha" >"$exif_metadata_app_icon_release_copy"
mkdir -p "$physical_pixel_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$physical_pixel_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$physical_pixel_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$physical_pixel_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_physical_pixel_metadata_app_icon_fixture "$physical_pixel_metadata_app_icon_zip_dir/fixture-root/LithePG.app"
physical_pixel_metadata_app_icon_marker="PHYSICAL_PIXEL_METADATA_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$physical_pixel_metadata_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$physical_pixel_metadata_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$physical_pixel_metadata_app_icon_zip" LithePG.app
)
physical_pixel_metadata_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$physical_pixel_metadata_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$physical_pixel_metadata_app_icon_zip_sha" >"$physical_pixel_metadata_app_icon_release_copy"
mkdir -p "$significant_bits_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$significant_bits_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$significant_bits_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$significant_bits_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_significant_bits_metadata_app_icon_fixture "$significant_bits_metadata_app_icon_zip_dir/fixture-root/LithePG.app"
significant_bits_metadata_app_icon_marker="SIGNIFICANT_BITS_METADATA_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$significant_bits_metadata_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$significant_bits_metadata_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$significant_bits_metadata_app_icon_zip" LithePG.app
)
significant_bits_metadata_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$significant_bits_metadata_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$significant_bits_metadata_app_icon_zip_sha" >"$significant_bits_metadata_app_icon_release_copy"
mkdir -p "$background_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$background_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$background_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$background_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_background_metadata_app_icon_fixture "$background_metadata_app_icon_zip_dir/fixture-root/LithePG.app"
background_metadata_app_icon_marker="BACKGROUND_METADATA_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$background_metadata_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$background_metadata_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$background_metadata_app_icon_zip" LithePG.app
)
background_metadata_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$background_metadata_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$background_metadata_app_icon_zip_sha" >"$background_metadata_app_icon_release_copy"
mkdir -p "$histogram_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$histogram_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$histogram_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$histogram_metadata_app_icon_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_histogram_metadata_app_icon_fixture "$histogram_metadata_app_icon_zip_dir/fixture-root/LithePG.app"
histogram_metadata_app_icon_marker="HISTOGRAM_METADATA_APP_ICON_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/codesign --force --sign - --options runtime "$histogram_metadata_app_icon_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$histogram_metadata_app_icon_zip_dir/fixture-root"
  /usr/bin/zip -qr "$histogram_metadata_app_icon_zip" LithePG.app
)
histogram_metadata_app_icon_zip_sha="$(/usr/bin/shasum -a 256 "$histogram_metadata_app_icon_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$histogram_metadata_app_icon_zip_sha" >"$histogram_metadata_app_icon_release_copy"
...
mkdir -p "$invalid_code_signature_zip_dir/fixture-root/LithePG.app/Contents/MacOS"
write_valid_info_plist "$invalid_code_signature_zip_dir/fixture-root/LithePG.app/Contents/Info.plist"
/bin/cp /usr/bin/true "$invalid_code_signature_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$invalid_code_signature_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/usr/bin/codesign --force --sign - "$invalid_code_signature_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
invalid_code_signature_marker="INVALID_CODE_SIGNATURE_FIXTURE_SHOULD_NOT_LEAK"
printf '%s\n' "$invalid_code_signature_marker" >>"$invalid_code_signature_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
(
  cd "$invalid_code_signature_zip_dir/fixture-root"
  /usr/bin/zip -qr "$invalid_code_signature_zip" LithePG.app
)
...
/bin/chmod 755 "$missing_runtime_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/usr/bin/codesign --force --sign - "$missing_runtime_zip_dir/fixture-root/LithePG.app" >/dev/null 2>&1
(
  cd "$missing_runtime_zip_dir/fixture-root"
  /usr/bin/zip -qr "$missing_runtime_zip" LithePG.app
)
...
printf '%s\n' "$text_executable_marker" >"$text_executable_bundle_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
/bin/chmod 755 "$text_executable_bundle_zip_dir/fixture-root/LithePG.app/Contents/MacOS/LithePGApp"
write_code_signature_resources "$text_executable_bundle_zip_dir/fixture-root/LithePG.app"
(
  cd "$text_executable_bundle_zip_dir/fixture-root"
  /usr/bin/zip -qr "$text_executable_bundle_zip" LithePG.app
)
...
zip_path, macho_path, duplicate_marker = sys.argv[1:4]
...
with zipfile.ZipFile(zip_path, "w") as archive:
    ...
    archive.writestr(zip_info("LithePG.app/Contents/MacOS/LithePGApp", 0o100755), (duplicate_marker + "\n").encode("utf-8"))
...
PY
duplicate_essential_entries_zip_sha="$(/usr/bin/shasum -a 256 "$duplicate_essential_entries_zip" | /usr/bin/cut -d ' ' -f 1)"
printf 'LithePG v1.0 release copy with approved SHA-256 %s.\n' "$duplicate_essential_entries_zip_sha" >"$duplicate_essential_entries_release_copy"
noncanonical_zip_path_marker="NONCANONICAL_ZIP_PATH_COLLISION_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/python3 - "$noncanonical_zip_path_zip" "/usr/bin/true" "$noncanonical_zip_path_marker" <<'PY'
import sys
import zipfile

zip_path, macho_path, noncanonical_marker = sys.argv[1:4]
...
with zipfile.ZipFile(zip_path, "w") as archive:
    archive.writestr(zip_info("LithePG.app/Contents/Info.plist", 0o100644), valid_info_plist)
    archive.writestr(zip_info("LithePG.app/Contents/MacOS/LithePGApp", 0o100755), macho_bytes)
    archive.writestr(zip_info("LithePG.app/Contents/MacOS//LithePGApp", 0o100755), (noncanonical_marker + "\n").encode("utf-8"))
    archive.writestr(zip_info("LithePG.app/Contents/_CodeSignature/CodeResources", 0o100644), b"fake code signature resources fixture\n")
PY
...
unicode_zip_path_collision_marker="UNICODE_ZIP_PATH_COLLISION_FIXTURE_SHOULD_NOT_LEAK"
/usr/bin/python3 - "$unicode_zip_path_collision_zip" "/usr/bin/true" "$unicode_zip_path_collision_marker" <<'PY'
import sys
import zipfile

zip_path, macho_path, unicode_marker = sys.argv[1:4]
...
with zipfile.ZipFile(zip_path, "w") as archive:
    archive.writestr(zip_info("LithePG.app/Contents/Info.plist", 0o100644), valid_info_plist)
    archive.writestr(zip_info("LithePG.app/Contents/MacOS/LithePGApp", 0o100755), macho_bytes)
    archive.writestr(zip_info("LithePG.app/Contents/Resources/ß.txt", 0o100644), (unicode_marker + "\n").encode("utf-8"))
    archive.writestr(zip_info("LithePG.app/Contents/Resources/SS.txt", 0o100644), b"ascii casefold peer fixture\n")
    archive.writestr(zip_info("LithePG.app/Contents/_CodeSignature/CodeResources", 0o100644), b"fake code signature resources fixture\n")
PY
...
assert_contains "$redaction_text" "Release artifact bundle executable mode: safe"
...
if run_gate_capture "$artifact_code_signature_resources_unsafe_mode_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$placeholder_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$placeholder_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$unsafe_code_resources_mode_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$unsafe_code_resources_mode_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_code_signature_resources_unsafe_mode_text="$(<"$artifact_code_signature_resources_unsafe_mode_output")"
  ...
  assert_not_contains "$artifact_code_signature_resources_unsafe_mode_text" "100666"
  fail "artifact-only gate unexpectedly passed with unsafe release artifact code signature resources mode"
fi
artifact_code_signature_resources_unsafe_mode_text="$(<"$artifact_code_signature_resources_unsafe_mode_output")"
...
assert_not_contains "$artifact_code_signature_resources_unsafe_mode_text" "rw-rw-rw-"
assert_not_contains "$artifact_code_signature_resources_unsafe_mode_text" "100666"
assert_not_contains "$artifact_code_signature_resources_unsafe_mode_text" "Release artifact code signature verification:"
assert_not_contains "$artifact_code_signature_resources_unsafe_mode_text" "External publication inputs"

if run_gate_capture "$artifact_code_signature_resources_empty_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$placeholder_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$placeholder_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$empty_code_resources_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$empty_code_resources_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_code_signature_resources_empty_text="$(<"$artifact_code_signature_resources_empty_output")"
  ...
  fail "artifact-only gate unexpectedly passed with empty release artifact code signature resources"
fi
artifact_code_signature_resources_empty_text="$(<"$artifact_code_signature_resources_empty_output")"
...
if run_gate_capture "$artifact_bundle_special_mode_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$special_mode_bundle_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$special_mode_bundle_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$special_mode_bundle_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$special_mode_bundle_zip_sha" \
  LITHEPG_CODESIGN_IDENTITY="configured" \
  LITHEPG_NOTARY_PROFILE="configured" \
  LITHEPG_SECURITY_CONTACT="configured" \
  LITHEPG_HOMEBREW_TAP="configured" \
  ...
  LITHEPG_RELEASE_COPY_APPROVED="approved" \
  LITHEPG_PUBLICATION_APPROVED="approved"; then
  artifact_bundle_special_mode_text="$(<"$artifact_bundle_special_mode_output")"
  ...
  assert_not_contains "$artifact_bundle_special_mode_text" "-rwxr-sr-x"
  fail "gate unexpectedly passed with unsafe release artifact executable mode"
fi
artifact_bundle_special_mode_text="$(<"$artifact_bundle_special_mode_output")"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact filename: matches"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact zip: present"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact app wrapper: present"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact bundle contents: present"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact bundle file types: regular"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact entry paths: canonical"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact essential entries: unique"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact Info.plist metadata: matches"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact bundle executable: executable"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact bundle executable mode: unsafe"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact executable format: Mach-O"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact code signature resources: present"
assert_contains "$artifact_bundle_special_mode_text" "Release artifact code signature verification: valid"
...
assert_not_contains "$artifact_bundle_special_mode_text" "-rwxr-sr-x"
assert_not_contains "$artifact_bundle_special_mode_text" "102755"
assert_not_contains "$artifact_bundle_special_mode_text" "fast preflight is clear"

if run_gate_capture "$artifact_bundle_writable_mode_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$writable_mode_bundle_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$writable_mode_bundle_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$writable_mode_bundle_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$writable_mode_bundle_zip_sha" \
  LITHEPG_CODESIGN_IDENTITY="configured" \
  LITHEPG_NOTARY_PROFILE="configured" \
  LITHEPG_SECURITY_CONTACT="configured" \
  LITHEPG_HOMEBREW_TAP="configured" \
  ...
  LITHEPG_RELEASE_COPY_APPROVED="approved" \
  LITHEPG_PUBLICATION_APPROVED="approved"; then
  artifact_bundle_writable_mode_text="$(<"$artifact_bundle_writable_mode_output")"
  ...
  fail "gate unexpectedly passed with group/world-writable release artifact executable mode"
fi
artifact_bundle_writable_mode_text="$(<"$artifact_bundle_writable_mode_output")"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact filename: matches"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact zip: present"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact app wrapper: present"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact bundle contents: present"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact bundle file types: regular"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact entry paths: canonical"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact essential entries: unique"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact Info.plist metadata: matches"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact bundle executable: executable"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact bundle executable mode: unsafe"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact executable format: Mach-O"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact code signature resources: present"
assert_contains "$artifact_bundle_writable_mode_text" "Release artifact code signature verification: valid"
...
if run_gate_capture "$artifact_app_icon_bad_low_resolution_sibling_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$bad_low_resolution_sibling_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$bad_low_resolution_sibling_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$bad_low_resolution_sibling_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$bad_low_resolution_sibling_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_bad_low_resolution_sibling_text="$(<"$artifact_app_icon_bad_low_resolution_sibling_output")"
  ...
  assert_not_contains "$artifact_app_icon_bad_low_resolution_sibling_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with a wrong-dimension PNG sibling in release artifact app icon"
fi
artifact_app_icon_bad_low_resolution_sibling_text="$(<"$artifact_app_icon_bad_low_resolution_sibling_output")"
assert_contains "$artifact_app_icon_bad_low_resolution_sibling_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_bad_low_resolution_sibling_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_bad_low_resolution_sibling_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_bad_low_resolution_sibling_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_bad_low_resolution_sibling_text" "$bad_low_resolution_sibling_app_icon_marker"
assert_not_contains "$artifact_app_icon_bad_low_resolution_sibling_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_bad_low_resolution_sibling_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_bad_low_resolution_sibling_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_duplicate_element_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$duplicate_element_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$duplicate_element_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$duplicate_element_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$duplicate_element_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_duplicate_element_text="$(<"$artifact_app_icon_duplicate_element_output")"
  ...
  fail "artifact-only gate unexpectedly passed with duplicate ICNS image elements in release artifact app icon"
fi
artifact_app_icon_duplicate_element_text="$(<"$artifact_app_icon_duplicate_element_output")"
assert_contains "$artifact_app_icon_duplicate_element_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_duplicate_element_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_duplicate_element_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_duplicate_element_text" "Release artifact Info.plist metadata: matches"
...
if run_gate_capture "$artifact_app_icon_invalid_chunk_type_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$invalid_chunk_type_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$invalid_chunk_type_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$invalid_chunk_type_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$invalid_chunk_type_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_invalid_chunk_type_text="$(<"$artifact_app_icon_invalid_chunk_type_output")"
  ...
  assert_not_contains "$artifact_app_icon_invalid_chunk_type_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with invalid PNG chunk type in release artifact app icon"
fi
artifact_app_icon_invalid_chunk_type_text="$(<"$artifact_app_icon_invalid_chunk_type_output")"
assert_contains "$artifact_app_icon_invalid_chunk_type_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_invalid_chunk_type_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_invalid_chunk_type_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_invalid_chunk_type_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_invalid_chunk_type_text" "$invalid_chunk_type_app_icon_marker"
assert_not_contains "$artifact_app_icon_invalid_chunk_type_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_invalid_chunk_type_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_invalid_chunk_type_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_reserved_bit_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$reserved_bit_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$reserved_bit_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$reserved_bit_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$reserved_bit_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_reserved_bit_text="$(<"$artifact_app_icon_reserved_bit_output")"
  ...
  assert_not_contains "$artifact_app_icon_reserved_bit_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with lowercase reserved PNG chunk byte in release artifact app icon"
fi
artifact_app_icon_reserved_bit_text="$(<"$artifact_app_icon_reserved_bit_output")"
assert_contains "$artifact_app_icon_reserved_bit_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_reserved_bit_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_reserved_bit_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_reserved_bit_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_reserved_bit_text" "$reserved_bit_app_icon_marker"
assert_not_contains "$artifact_app_icon_reserved_bit_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_reserved_bit_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_reserved_bit_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_unknown_critical_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$unknown_critical_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$unknown_critical_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$unknown_critical_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$unknown_critical_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_unknown_critical_text="$(<"$artifact_app_icon_unknown_critical_output")"
  ...
  assert_not_contains "$artifact_app_icon_unknown_critical_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with unknown critical PNG chunk in release artifact app icon"
fi
artifact_app_icon_unknown_critical_text="$(<"$artifact_app_icon_unknown_critical_output")"
assert_contains "$artifact_app_icon_unknown_critical_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_unknown_critical_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_unknown_critical_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_unknown_critical_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_unknown_critical_text" "$unknown_critical_app_icon_marker"
assert_not_contains "$artifact_app_icon_unknown_critical_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_unknown_critical_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_unknown_critical_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_unknown_ancillary_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$unknown_ancillary_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$unknown_ancillary_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$unknown_ancillary_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$unknown_ancillary_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_unknown_ancillary_text="$(<"$artifact_app_icon_unknown_ancillary_output")"
  ...
  assert_not_contains "$artifact_app_icon_unknown_ancillary_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with unknown ancillary PNG chunk in release artifact app icon"
fi
artifact_app_icon_unknown_ancillary_text="$(<"$artifact_app_icon_unknown_ancillary_output")"
assert_contains "$artifact_app_icon_unknown_ancillary_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_unknown_ancillary_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_unknown_ancillary_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_unknown_ancillary_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_unknown_ancillary_text" "$unknown_ancillary_app_icon_marker"
assert_not_contains "$artifact_app_icon_unknown_ancillary_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_unknown_ancillary_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_unknown_ancillary_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_invalid_srgb_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$invalid_srgb_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$invalid_srgb_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$invalid_srgb_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$invalid_srgb_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_invalid_srgb_text="$(<"$artifact_app_icon_invalid_srgb_output")"
  ...
  assert_not_contains "$artifact_app_icon_invalid_srgb_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with invalid PNG sRGB chunk in release artifact app icon"
fi
artifact_app_icon_invalid_srgb_text="$(<"$artifact_app_icon_invalid_srgb_output")"
assert_contains "$artifact_app_icon_invalid_srgb_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_invalid_srgb_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_invalid_srgb_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_invalid_srgb_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_invalid_srgb_text" "$invalid_srgb_app_icon_marker"
assert_not_contains "$artifact_app_icon_invalid_srgb_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_invalid_srgb_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_invalid_srgb_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_invalid_gama_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$invalid_gama_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$invalid_gama_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$invalid_gama_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$invalid_gama_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_invalid_gama_text="$(<"$artifact_app_icon_invalid_gama_output")"
  ...
  assert_not_contains "$artifact_app_icon_invalid_gama_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with invalid PNG gAMA chunk in release artifact app icon"
fi
artifact_app_icon_invalid_gama_text="$(<"$artifact_app_icon_invalid_gama_output")"
assert_contains "$artifact_app_icon_invalid_gama_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_invalid_gama_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_invalid_gama_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_invalid_gama_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_invalid_gama_text" "$invalid_gama_app_icon_marker"
assert_not_contains "$artifact_app_icon_invalid_gama_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_invalid_gama_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_invalid_gama_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_invalid_chrm_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$invalid_chrm_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$invalid_chrm_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$invalid_chrm_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$invalid_chrm_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_invalid_chrm_text="$(<"$artifact_app_icon_invalid_chrm_output")"
  ...
  assert_not_contains "$artifact_app_icon_invalid_chrm_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with invalid PNG cHRM chunk in release artifact app icon"
fi
artifact_app_icon_invalid_chrm_text="$(<"$artifact_app_icon_invalid_chrm_output")"
assert_contains "$artifact_app_icon_invalid_chrm_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_invalid_chrm_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_invalid_chrm_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_invalid_chrm_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_invalid_chrm_text" "$invalid_chrm_app_icon_marker"
assert_not_contains "$artifact_app_icon_invalid_chrm_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_invalid_chrm_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_invalid_chrm_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_invalid_iccp_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$invalid_iccp_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$invalid_iccp_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$invalid_iccp_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$invalid_iccp_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_invalid_iccp_text="$(<"$artifact_app_icon_invalid_iccp_output")"
  ...
  assert_not_contains "$artifact_app_icon_invalid_iccp_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with invalid PNG iCCP chunk in release artifact app icon"
fi
artifact_app_icon_invalid_iccp_text="$(<"$artifact_app_icon_invalid_iccp_output")"
assert_contains "$artifact_app_icon_invalid_iccp_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_invalid_iccp_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_invalid_iccp_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_invalid_iccp_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_invalid_iccp_text" "$invalid_iccp_app_icon_marker"
assert_not_contains "$artifact_app_icon_invalid_iccp_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_invalid_iccp_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_invalid_iccp_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_oversized_dimensions_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$oversized_dimensions_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$oversized_dimensions_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$oversized_dimensions_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$oversized_dimensions_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_oversized_dimensions_text="$(<"$artifact_app_icon_oversized_dimensions_output")"
  ...
  fail "artifact-only gate unexpectedly passed with oversized PNG dimensions in release artifact app icon"
fi
artifact_app_icon_oversized_dimensions_text="$(<"$artifact_app_icon_oversized_dimensions_output")"
assert_contains "$artifact_app_icon_oversized_dimensions_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_oversized_dimensions_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_oversized_dimensions_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_oversized_dimensions_text" "Release artifact Info.plist metadata: matches"
...
if run_gate_capture "$artifact_app_icon_trns_alpha_output" env -i \
  ...
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$trns_alpha_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$trns_alpha_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_trns_alpha_text="$(<"$artifact_app_icon_trns_alpha_output")"
  ...
  fail "artifact-only gate unexpectedly passed with forbidden PNG tRNS in release artifact app icon"
fi
artifact_app_icon_trns_alpha_text="$(<"$artifact_app_icon_trns_alpha_output")"
assert_contains "$artifact_app_icon_trns_alpha_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_trns_alpha_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_trns_alpha_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_trns_alpha_text" "Release artifact Info.plist metadata: matches"
...
if run_gate_capture "$artifact_app_icon_text_metadata_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$text_metadata_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$text_metadata_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$text_metadata_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$text_metadata_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_text_metadata_text="$(<"$artifact_app_icon_text_metadata_output")"
  ...
  assert_not_contains "$artifact_app_icon_text_metadata_text" "Comment"
  assert_not_contains "$artifact_app_icon_text_metadata_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with PNG text metadata in release artifact app icon"
fi
artifact_app_icon_text_metadata_text="$(<"$artifact_app_icon_text_metadata_output")"
assert_contains "$artifact_app_icon_text_metadata_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_text_metadata_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_text_metadata_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_text_metadata_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_text_metadata_text" "Comment"
assert_not_contains "$artifact_app_icon_text_metadata_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_text_metadata_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_text_metadata_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_timestamp_metadata_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$timestamp_metadata_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$timestamp_metadata_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$timestamp_metadata_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$timestamp_metadata_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_timestamp_metadata_text="$(<"$artifact_app_icon_timestamp_metadata_output")"
  ...
  assert_not_contains "$artifact_app_icon_timestamp_metadata_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with PNG timestamp metadata in release artifact app icon"
fi
artifact_app_icon_timestamp_metadata_text="$(<"$artifact_app_icon_timestamp_metadata_output")"
assert_contains "$artifact_app_icon_timestamp_metadata_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_timestamp_metadata_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_timestamp_metadata_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_timestamp_metadata_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_timestamp_metadata_text" "$timestamp_metadata_app_icon_marker"
assert_not_contains "$artifact_app_icon_timestamp_metadata_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_timestamp_metadata_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_timestamp_metadata_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_exif_metadata_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$exif_metadata_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$exif_metadata_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$exif_metadata_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$exif_metadata_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_exif_metadata_text="$(<"$artifact_app_icon_exif_metadata_output")"
  ...
  assert_not_contains "$artifact_app_icon_exif_metadata_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with PNG EXIF metadata in release artifact app icon"
fi
artifact_app_icon_exif_metadata_text="$(<"$artifact_app_icon_exif_metadata_output")"
assert_contains "$artifact_app_icon_exif_metadata_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_exif_metadata_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_exif_metadata_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_exif_metadata_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_exif_metadata_text" "$exif_metadata_app_icon_marker"
assert_not_contains "$artifact_app_icon_exif_metadata_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_exif_metadata_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_exif_metadata_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_physical_pixel_metadata_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$physical_pixel_metadata_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$physical_pixel_metadata_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$physical_pixel_metadata_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$physical_pixel_metadata_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_physical_pixel_metadata_text="$(<"$artifact_app_icon_physical_pixel_metadata_output")"
  ...
  assert_not_contains "$artifact_app_icon_physical_pixel_metadata_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with PNG physical pixel metadata in release artifact app icon"
fi
artifact_app_icon_physical_pixel_metadata_text="$(<"$artifact_app_icon_physical_pixel_metadata_output")"
assert_contains "$artifact_app_icon_physical_pixel_metadata_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_physical_pixel_metadata_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_physical_pixel_metadata_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_physical_pixel_metadata_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_physical_pixel_metadata_text" "$physical_pixel_metadata_app_icon_marker"
assert_not_contains "$artifact_app_icon_physical_pixel_metadata_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_physical_pixel_metadata_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_physical_pixel_metadata_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_significant_bits_metadata_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$significant_bits_metadata_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$significant_bits_metadata_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$significant_bits_metadata_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$significant_bits_metadata_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_significant_bits_metadata_text="$(<"$artifact_app_icon_significant_bits_metadata_output")"
  ...
  assert_not_contains "$artifact_app_icon_significant_bits_metadata_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with PNG significant-bit metadata in release artifact app icon"
fi
artifact_app_icon_significant_bits_metadata_text="$(<"$artifact_app_icon_significant_bits_metadata_output")"
assert_contains "$artifact_app_icon_significant_bits_metadata_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_significant_bits_metadata_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_significant_bits_metadata_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_significant_bits_metadata_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_significant_bits_metadata_text" "$significant_bits_metadata_app_icon_marker"
assert_not_contains "$artifact_app_icon_significant_bits_metadata_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_significant_bits_metadata_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_significant_bits_metadata_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_background_metadata_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$background_metadata_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$background_metadata_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$background_metadata_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$background_metadata_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_background_metadata_text="$(<"$artifact_app_icon_background_metadata_output")"
  ...
  assert_not_contains "$artifact_app_icon_background_metadata_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with PNG background metadata in release artifact app icon"
fi
artifact_app_icon_background_metadata_text="$(<"$artifact_app_icon_background_metadata_output")"
assert_contains "$artifact_app_icon_background_metadata_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_background_metadata_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_background_metadata_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_background_metadata_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_background_metadata_text" "$background_metadata_app_icon_marker"
assert_not_contains "$artifact_app_icon_background_metadata_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_background_metadata_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_background_metadata_text" "fast preflight is clear"

if run_gate_capture "$artifact_app_icon_histogram_metadata_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$histogram_metadata_app_icon_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$histogram_metadata_app_icon_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$histogram_metadata_app_icon_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$histogram_metadata_app_icon_zip_sha" \
  /bin/bash -c 'exec "$1" --artifact-only' _; then
  artifact_app_icon_histogram_metadata_text="$(<"$artifact_app_icon_histogram_metadata_output")"
  ...
  assert_not_contains "$artifact_app_icon_histogram_metadata_text" "AppIcon.icns"
  fail "artifact-only gate unexpectedly passed with PNG histogram metadata in release artifact app icon"
fi
artifact_app_icon_histogram_metadata_text="$(<"$artifact_app_icon_histogram_metadata_output")"
assert_contains "$artifact_app_icon_histogram_metadata_text" "Artifact-only mode: enabled"
assert_contains "$artifact_app_icon_histogram_metadata_text" "Release artifact filename: matches"
assert_contains "$artifact_app_icon_histogram_metadata_text" "Release artifact zip: present"
assert_contains "$artifact_app_icon_histogram_metadata_text" "Release artifact Info.plist metadata: matches"
...
assert_not_contains "$artifact_app_icon_histogram_metadata_text" "$histogram_metadata_app_icon_marker"
assert_not_contains "$artifact_app_icon_histogram_metadata_text" "AppIcon.icns"
assert_not_contains "$artifact_app_icon_histogram_metadata_text" "External publication inputs"
assert_not_contains "$artifact_app_icon_histogram_metadata_text" "fast preflight is clear"
...
if run_gate_capture "$artifact_executable_format_invalid_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$text_executable_bundle_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$text_executable_bundle_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$text_executable_bundle_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$text_executable_bundle_zip_sha" \
  LITHEPG_CODESIGN_IDENTITY="configured" \
  LITHEPG_NOTARY_PROFILE="configured" \
  LITHEPG_SECURITY_CONTACT="configured" \
  LITHEPG_HOMEBREW_TAP="configured" \
  ...
  LITHEPG_RELEASE_COPY_APPROVED="approved" \
  LITHEPG_PUBLICATION_APPROVED="approved"; then
  artifact_executable_format_invalid_text="$(<"$artifact_executable_format_invalid_output")"
  ...
  fail "gate unexpectedly passed with text executable release artifact"
fi
artifact_executable_format_invalid_text="$(<"$artifact_executable_format_invalid_output")"
assert_contains "$artifact_executable_format_invalid_text" "Release artifact filename: matches"
assert_contains "$artifact_executable_format_invalid_text" "Release artifact zip: present"
assert_contains "$artifact_executable_format_invalid_text" "Release artifact app wrapper: present"
assert_contains "$artifact_executable_format_invalid_text" "Release artifact bundle contents: present"
assert_contains "$artifact_executable_format_invalid_text" "Release artifact bundle file types: regular"
assert_contains "$artifact_executable_format_invalid_text" "Release artifact Info.plist metadata: matches"
assert_contains "$artifact_executable_format_invalid_text" "Release artifact bundle executable: executable"
assert_contains "$artifact_executable_format_invalid_text" "Release artifact executable format: invalid"
...
if run_gate_capture "$artifact_duplicate_essential_entries_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$duplicate_essential_entries_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$duplicate_essential_entries_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$duplicate_essential_entries_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$duplicate_essential_entries_zip_sha" \
  LITHEPG_CODESIGN_IDENTITY="configured" \
  LITHEPG_NOTARY_PROFILE="configured" \
  LITHEPG_SECURITY_CONTACT="configured" \
  LITHEPG_HOMEBREW_TAP="configured" \
  ...
  LITHEPG_RELEASE_COPY_APPROVED="approved" \
  LITHEPG_PUBLICATION_APPROVED="approved"; then
  artifact_duplicate_essential_entries_text="$(<"$artifact_duplicate_essential_entries_output")"
  ...
  fail "gate unexpectedly passed with duplicate essential release artifact entries"
fi
artifact_duplicate_essential_entries_text="$(<"$artifact_duplicate_essential_entries_output")"
assert_contains "$artifact_duplicate_essential_entries_text" "Release artifact filename: matches"
assert_contains "$artifact_duplicate_essential_entries_text" "Release artifact zip: present"
...
if run_gate_capture "$artifact_noncanonical_zip_path_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$noncanonical_zip_path_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$noncanonical_zip_path_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$noncanonical_zip_path_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$noncanonical_zip_path_zip_sha" \
  LITHEPG_CODESIGN_IDENTITY="configured" \
  LITHEPG_NOTARY_PROFILE="configured" \
  LITHEPG_SECURITY_CONTACT="configured" \
  LITHEPG_HOMEBREW_TAP="configured" \
  ...
  LITHEPG_RELEASE_COPY_APPROVED="approved" \
  LITHEPG_PUBLICATION_APPROVED="approved"; then
  artifact_noncanonical_zip_path_text="$(<"$artifact_noncanonical_zip_path_output")"
  ...
  fail "gate unexpectedly passed with non-canonical release artifact zip path collision"
fi
artifact_noncanonical_zip_path_text="$(<"$artifact_noncanonical_zip_path_output")"
assert_contains "$artifact_noncanonical_zip_path_text" "Release artifact filename: matches"
assert_contains "$artifact_noncanonical_zip_path_text" "Release artifact zip: present"
assert_contains "$artifact_noncanonical_zip_path_text" "Release artifact app wrapper: present"
assert_contains "$artifact_noncanonical_zip_path_text" "Release artifact bundle contents: present"
...
if run_gate_capture "$artifact_unicode_zip_path_collision_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$unicode_zip_path_collision_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$unicode_zip_path_collision_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$unicode_zip_path_collision_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$unicode_zip_path_collision_zip_sha" \
  LITHEPG_CODESIGN_IDENTITY="configured" \
  LITHEPG_NOTARY_PROFILE="configured" \
  LITHEPG_SECURITY_CONTACT="configured" \
  LITHEPG_HOMEBREW_TAP="configured" \
  ...
  LITHEPG_RELEASE_COPY_APPROVED="approved" \
  LITHEPG_PUBLICATION_APPROVED="approved"; then
  artifact_unicode_zip_path_collision_text="$(<"$artifact_unicode_zip_path_collision_output")"
  ...
  fail "gate unexpectedly passed with non-ASCII release artifact zip path"
fi
artifact_unicode_zip_path_collision_text="$(<"$artifact_unicode_zip_path_collision_output")"
assert_contains "$artifact_unicode_zip_path_collision_text" "Release artifact filename: matches"
assert_contains "$artifact_unicode_zip_path_collision_text" "Release artifact zip: present"
assert_contains "$artifact_unicode_zip_path_collision_text" "Release artifact app wrapper: present"
assert_contains "$artifact_unicode_zip_path_collision_text" "Release artifact bundle contents: present"
...
assert_not_contains "$artifact_unicode_zip_path_collision_text" "LithePG.app/Contents/Resources/SS.txt"
...
if run_gate_capture "$artifact_code_signature_verification_invalid_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$invalid_code_signature_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$invalid_code_signature_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$invalid_code_signature_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$invalid_code_signature_zip_sha" \
  LITHEPG_CODESIGN_IDENTITY="configured" \
  LITHEPG_NOTARY_PROFILE="configured" \
  LITHEPG_SECURITY_CONTACT="configured" \
  LITHEPG_HOMEBREW_TAP="configured" \
  ...
  LITHEPG_RELEASE_COPY_APPROVED="approved" \
  LITHEPG_PUBLICATION_APPROVED="approved"; then
  artifact_code_signature_verification_invalid_text="$(<"$artifact_code_signature_verification_invalid_output")"
  ...
  fail "gate unexpectedly passed with invalid release artifact code signature"
fi
artifact_code_signature_verification_invalid_text="$(<"$artifact_code_signature_verification_invalid_output")"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact filename: matches"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact zip: present"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact app wrapper: present"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact bundle contents: present"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact bundle file types: regular"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact entry paths: canonical"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact essential entries: unique"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact Info.plist metadata: matches"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact bundle executable: executable"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact executable format: Mach-O"
assert_contains "$artifact_code_signature_verification_invalid_text" "Release artifact code signature resources: present"
...
assert_not_contains "$artifact_code_signature_verification_invalid_text" "LithePG.app/Contents/MacOS/LithePGApp"
assert_not_contains "$artifact_code_signature_verification_invalid_text" "a sealed resource is missing or invalid"
assert_not_contains "$artifact_code_signature_verification_invalid_text" "not valid for use in process"
...
if run_gate_capture "$artifact_code_signature_runtime_missing_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$missing_runtime_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$missing_runtime_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$missing_runtime_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$missing_runtime_zip_sha" \
  LITHEPG_CODESIGN_IDENTITY="configured" \
  LITHEPG_NOTARY_PROFILE="configured" \
  LITHEPG_SECURITY_CONTACT="configured" \
  LITHEPG_HOMEBREW_TAP="configured" \
  ...
  LITHEPG_RELEASE_COPY_APPROVED="approved" \
  LITHEPG_PUBLICATION_APPROVED="approved"; then
  artifact_code_signature_runtime_missing_text="$(<"$artifact_code_signature_runtime_missing_output")"
  ...
  fail "gate unexpectedly passed with release artifact code signature missing Hardened Runtime"
fi
artifact_code_signature_runtime_missing_text="$(<"$artifact_code_signature_runtime_missing_output")"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact filename: matches"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact zip: present"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact app wrapper: present"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact bundle contents: present"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact bundle file types: regular"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact entry paths: canonical"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact essential entries: unique"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact Info.plist metadata: matches"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact bundle executable: executable"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact executable format: Mach-O"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact code signature resources: present"
assert_contains "$artifact_code_signature_runtime_missing_text" "Release artifact code signature verification: valid"
...
assert_not_contains "$artifact_code_signature_runtime_missing_text" "Executable="
assert_not_contains "$artifact_code_signature_runtime_missing_text" "Authority="
assert_not_contains "$artifact_code_signature_runtime_missing_text" "TeamIdentifier="
...
if run_gate_capture "$artifact_info_plist_metadata_mismatch_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$invalid_metadata_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$invalid_metadata_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$invalid_metadata_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$invalid_metadata_zip_sha" \
  LITHEPG_CODESIGN_IDENTITY="configured" \
  LITHEPG_NOTARY_PROFILE="configured" \
  LITHEPG_SECURITY_CONTACT="configured" \
  LITHEPG_HOMEBREW_TAP="configured" \
  ...
  LITHEPG_RELEASE_COPY_APPROVED="approved" \
  LITHEPG_PUBLICATION_APPROVED="approved"; then
  artifact_info_plist_metadata_mismatch_text="$(<"$artifact_info_plist_metadata_mismatch_output")"
  assert_not_contains "$artifact_info_plist_metadata_mismatch_text" "$invalid_metadata_zip_sha"
  fail "gate unexpectedly passed with mismatched release artifact Info.plist metadata"
fi
artifact_info_plist_metadata_mismatch_text="$(<"$artifact_info_plist_metadata_mismatch_output")"
assert_contains "$artifact_info_plist_metadata_mismatch_text" "Release artifact filename: matches"
assert_contains "$artifact_info_plist_metadata_mismatch_text" "Release artifact zip: present"
assert_contains "$artifact_info_plist_metadata_mismatch_text" "Release artifact app wrapper: present"
assert_contains "$artifact_info_plist_metadata_mismatch_text" "Release artifact bundle contents: present"
assert_contains "$artifact_info_plist_metadata_mismatch_text" "Release artifact bundle file types: regular"
assert_contains "$artifact_info_plist_metadata_mismatch_text" "Release artifact Info.plist metadata: mismatch"
...
if run_gate_capture "$artifact_info_plist_metadata_cannot_inspect_output" env -i \
  PATH="$fake_path" \
  FAKE_GIT_LS_REMOTE_MARKER="$fake_git_marker" \
  LITHEPG_RELEASE_COPY_PATH="$malformed_metadata_release_copy" \
  LITHEPG_HOMEBREW_CASK_PATH="$malformed_metadata_homebrew_cask" \
  LITHEPG_SECURITY_DOC_PATH="$placeholder_free_security_doc" \
  LITHEPG_RELEASE_ZIP_PATH="$malformed_metadata_zip" \
  LITHEPG_RELEASE_ZIP_SHA256="$malformed_metadata_zip_sha" \
  LITHEPG_CODESIGN_IDENTITY="configured" \
  LITHEPG_NOTARY_PROFILE="configured" \
  LITHEPG_SECURITY_CONTACT="configured" \
  LITHEPG_HOMEBREW_TAP="configured" \
  ...
  LITHEPG_RELEASE_COPY_APPROVED="approved" \
  LITHEPG_PUBLICATION_APPROVED="approved"; then
  artifact_info_plist_metadata_cannot_inspect_text="$(<"$artifact_info_plist_metadata_cannot_inspect_output")"
  ...
  fail "gate unexpectedly passed with malformed release artifact Info.plist metadata"
fi
artifact_info_plist_metadata_cannot_inspect_text="$(<"$artifact_info_plist_metadata_cannot_inspect_output")"
assert_contains "$artifact_info_plist_metadata_cannot_inspect_text" "Release artifact filename: matches"
assert_contains "$artifact_info_plist_metadata_cannot_inspect_text" "Release artifact zip: present"
assert_contains "$artifact_info_plist_metadata_cannot_inspect_text" "Release artifact app wrapper: present"
assert_contains "$artifact_info_plist_metadata_cannot_inspect_text" "Release artifact bundle contents: present"
assert_contains "$artifact_info_plist_metadata_cannot_inspect_text" "Release artifact bundle file types: regular"
assert_contains "$artifact_info_plist_metadata_cannot_inspect_text" "Release artifact Info.plist metadata: could not inspect"
...
assert_not_contains "$artifact_info_plist_metadata_cannot_inspect_text" "fast preflight is clear"
...
assert_contains "$no_remote_lookup_text" "Release artifact entry paths: canonical"
assert_contains "$no_remote_lookup_text" "Release artifact essential entries: unique"
...
assert_contains "$no_remote_lookup_text" "Release artifact executable format: Mach-O"
assert_contains "$no_remote_lookup_text" "Release artifact code signature resources: present"
assert_contains "$no_remote_lookup_text" "Release artifact code signature verification: valid"
