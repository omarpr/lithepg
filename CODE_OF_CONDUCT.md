...
We as contributors, maintainers, and participants pledge to make participation in
LithePG a harassment-free experience for everyone, regardless of age, body size,
...
- Posting credentials, tokens, private schemas, real query results, or other
  confidential user/project data in public project spaces.
...
The project lead will follow these Community Impact Guidelines in determining the
...
communication with the project for a specified period of time. Violating these
